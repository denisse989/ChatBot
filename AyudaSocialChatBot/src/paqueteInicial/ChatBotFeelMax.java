					 ...
					 if (!vent && !joke){
						 switch(entry.getValue()){
							...
							case MEETME:{
								...
								String getSub="";
								if (entry.getKey().equals("im")){
									getSub="im";
								}
								
								if (!getSub.equals("") ){
									for(String value:badfeelings){
										if (analyzer.contains(value) || ((analyzer.contains("feel")&&analyzer.contains(value)))){
								...
								} else if (entry.getKey().equals("i feel")){
